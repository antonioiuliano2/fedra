...
//-----------------------------------------------------------------
/*void check_cp(char *csignal_cut="1") //ROOT6 does not like ambiguous methods, it may be confused with void check_cp(int output=0, char *fname=0, char *csignal_cut="1")
{
