...
class EdbShowAlg_NN : public EdbShowAlg {
  ...
  private:
    ...
    Float_t eANN_var_dT_InBT_To_TestBT;  Float_t eANN_var_dR_InBT_To_TestBT;
    Float_t eANN_var_dR_TestBT_To_InBT;  Float_t eANN_var_zDist_TestBT_To_InBT;
    Float_t eANN_var_SpatialDist_TestBT_To_InBT;  Float_t eANN_var_zDiff_TestBT_To_InBT;
    Float_t eANN_var_dT_NextBT_To_TestBT;  Float_t eANN_var_dR_NextBT_To_TestBT;
    Float_t eANN_var_mean_dT_2before;    Float_t eANN_var_mean_dR_2before;
    Float_t  eANN_var_mean_dT_before;    Float_t eANN_var_mean_dR_before;
    Float_t  eANN_var_mean_dT_same;   Float_t eANN_var_mean_dR_same;
    Float_t  eANN_var_mean_dT_after;   Float_t eANN_var_mean_dR_after;
    Float_t  eANN_var_mean_dT_2after;  Float_t  eANN_var_mean_dR_2after;
    Float_t eANN_var_min_dT_2before;    Float_t eANN_var_min_dR_2before;
    Float_t  eANN_var_min_dT_before;    Float_t eANN_var_min_dR_before;
    Float_t  eANN_var_min_dT_same;   Float_t eANN_var_min_dR_same;
    Float_t  eANN_var_min_dT_after;   Float_t eANN_var_min_dR_after;
    Float_t  eANN_var_min_dT_2after;  Float_t  eANN_var_min_dR_2after;
    Int_t eANN_var_nseg_1before;  Int_t eANN_var_nseg_2before;  Int_t eANN_var_nseg_3before;
    Int_t eANN_var_nseg_1after;  Int_t eANN_var_nseg_2after;  Int_t eANN_var_nseg_3after;
    Int_t eANN_var_nseg_same;  Int_t eANN_var_type;
  ...
  public:
    ...
    inline  void SetWeightFileString(TString WeightFileString) { eWeightFileString=WeightFileString; return; } 
    
    inline  TString GetWeightFileString() { return eWeightFileString; } 
