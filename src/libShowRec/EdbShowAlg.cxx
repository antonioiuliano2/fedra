...
if (gEDBDEBUGLEVEL>2) cout << "EdbShowAlg::Transform_eAli   eAli_Sub  created."<<endl;
...
cout << "        ...." << endl;
cout << "        Then you set you input: " << endl;
cout << "        ->SetEdbPVRec(gAli) : " << endl;
cout << "        Then you execute the algorithm: " << endl;
cout << "        ->Execute() : " << endl;
cout << "        Finally you get the TObjArray of reconstructed showers (EdbShowerP*): " << endl;
...
eParaValue[0]=0;
eParaString[0]="MINIMUM_P";    // threshold cut on s->P()
eParaValue[1]=1000;
eParaString[1]="EXTRACTIONSIZE";          // size cut on the eAliSub to choose
...
InBT=(EdbSegP*)eInBTArray->At(i);
if (gEDBDEBUGLEVEL>2) InBT->PrintNice();
Float_t X0=InBT->X();Float_t Y0=InBT->Y();
...
if ( Abs(Segment->X()-X0) > 7000 ) continue;   if ( Abs(Segment->Y()-Y0) > 7000 ) continue;
