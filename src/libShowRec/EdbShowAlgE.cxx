...
// 				if (!CheckStringToShowAlgEParaName(tmpString2)) break;
			...
			else if ( !strcmp(key,"SHOW_ENERGY_READ_WEIGHTFILE_PLATES")  )
			{
				...
				for(int i=0; i<nspec-1; i++ ) { cout <<"  " << spec[i]; }
...
{    
	...
	if (eMLP_SimpleTree) { delete eMLP_SimpleTree; eMLP_SimpleTree=0; cout << "deletion done"<<endl;}
...
void EdbShowAlgE::FillInputHistosPara_XX()
{
	...
	for (int i=0; i<eMLP_SimpleTree->GetEntries(); ++i) {
		...
		for (Int_t j=0; j<70; j++) { eInANN_Hist[j]->Fill(eInANN[j]); }
	}
...
void EdbShowAlgE::CreateMLPLayouts()
{
	...
	switch (eShowAlgEParaNr) { 
		case 0 :  CreateMLPLayouts_FJ();
		break;
		case 1 :  CreateMLPLayouts_LT();
		break;
		case 2 :  CreateMLPLayouts_YC();
		break;
		case 3 :  CreateMLPLayouts_JC();
		break;
		case 4 :  CreateMLPLayouts_XX();
		break;
		case 5 :  CreateMLPLayouts_YY();
		break;
		default : CreateMLPLayouts_XX();
		break;
	}
	...
	switch (eShowAlgEParaNr) { 
		case 0 :  //CreateInputNeuronsArray_FJ();
			...
			case 1 :  //CreateInputNeuronsArray_LT();
				break;
				case 2 :  CreateInputNeuronsArray_YC();
				break;
				case 3 :  //CreateInputNeuronsArray_JC();
					break;
					case 4 :  CreateInputNeuronsArray_XX();
					break;
						
					case 5 :  CreateInputNeuronsArray_YY();
					break;
						
					default : CreateInputNeuronsArray_XX();
					break;
	}
...
void EdbShowAlgE::SetBinsInputHistos() {
	...
	switch (eShowAlgEParaNr) { 
		case 0 :  SetBinsInputHistos_FJ();
		break;
		case 1 :  //CreateInputNeuronsArray_LT();
			break;
			case 2 :  SetBinsInputHistos_YY();
			break;
			case 3 :  //CreateInputNeuronsArray_JC();
				break;
				case 4 :  SetBinsInputHistos_XX();
				break;
				case 5 :  SetBinsInputHistos_YY();
				break;
				default : SetBinsInputHistos_XX();
				break;
	}
	return;
}
