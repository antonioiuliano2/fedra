...
//     Float_t             eInANN[70];
  ...
  public:
    ...
    inline void         SetMLPLayout(TString layout)      { eMLP_Layout = layout; }
    inline void         SetMLPWeightFileName(TString weightfilename)      { eMLP_WeightFileName = weightfilename; }
    inline void         SetMLPInputFileName(TString MLP_InputFileName)  { eMLP_InputFileName = MLP_InputFileName; }    
    inline void         SetMLPTrainEpochs(Int_t nep)      { eMLP_TrainEpochs = nep; }
    inline void         SetMLPArrayN(Int_t MLPArrayN)      { eMLPArrayN = MLPArrayN; }
    
    inline void         SetPlatesN(Int_t ShowAlgEPlatesN)      { eShowAlgEPlatesN = ShowAlgEPlatesN; }
    ...
    // Get Functions
    inline TMultiLayerPerceptron*         GetMLP() const     { return eMLP_Simple; }
    
    inline TH1F*        GetHistInANN(Int_t nr)   const { return eInANN_Hist[nr]; }
    
    inline TString      GetMLPLayout()              { return eMLP_Layout; }
    inline TString      GetMLPWeightFileName()      { return eMLP_WeightFileName; }
    inline TString      GetMLPInputFileName()       { return eMLP_InputFileName; }
    inline Int_t        SetMLPTrainEpochs()         { return eMLP_TrainEpochs; }
