...
//     EdbShowRec(TString treebranchFileName); // DEBUG // doesnt work, see explanation in .cxx file
    ...
    inline void         SetDoReconstruction( Int_t dospec )            {
        eDoReconstruction = dospec;
    }
    inline void         SetDoParametrisation( Int_t dospec )           {
        eDoParametrization = dospec;
    }
    inline void         SetDoId( Int_t dospec )                        {
        eDoId = dospec;
    }
    inline void         SetDoEnergy( Int_t dospec )                    {
        eDoEnergy = dospec;
    }
    inline void         SetDoVtxAttach( Int_t dospec )                 {
        eDoVtxAttach = dospec;
    }
    ...
    inline void         SetShowAlgArray( TObjArray* ShowAlgArray ) {
        ...
        eShowAlgArrayN=eShowAlgArray->GetEntries();
    }
    ...
    inline void         SetShowAlgArrayN(Int_t ShowAlgArrayN)      {
        eShowAlgArrayN = ShowAlgArrayN;
    }
    ...
    inline void         SetFirstPlate( Int_t FirstPlate )          {
        eFirstPlate = FirstPlate;
    }
    inline void         SetLastPlate( Int_t LastPlate )            {
        eLastPlate = LastPlate;
    }
    inline void         SetMiddlePlate( Int_t MiddlePlate )          {
        eMiddlePlate = MiddlePlate;
    }
    inline void         SetNumberPlate( Int_t NumberPlate )          {
        eNumberPlate = NumberPlate;
    }
    ...
    inline void         SetShowName(TString Name_Out_shower)      {
        eName_Out_shower = Name_Out_shower;
    }
    inline void         SetWriteFileShower(Int_t WriteFileShower) {
        eWriteFileShower = WriteFileShower;
    }
    inline void         SetTreebranchName(TString Name_Out_treebranch)      {
        eName_Out_treebranch = Name_Out_treebranch;
    }

    inline void         SetShowFileName(TString Filename_Out_shower)      {
        eFilename_Out_shower = Filename_Out_shower;
    }
    inline void         SetWriteFileTreebranch(Int_t WriteFileTreebranch) {
        eWriteFileTreebranch = WriteFileTreebranch;
    }
    inline void         SetTreebranchFileName(TString Filename_Out_treebranch)      {
        eFilename_Out_treebranch = Filename_Out_treebranch;
    }
    ...
    inline Int_t        GetShowAlgArrayN()  const       {
        return eShowAlgArrayN;
    }
    ...
    inline Int_t        GetFirstPlate( )      const       {
        return eFirstPlate;
    }
    inline Int_t        GetLastPlate( )      const       {
        return eLastPlate;
    }
    inline Int_t        GetMiddlePlate( )      const       {
        return eMiddlePlate;
    }
    inline Int_t        GetNumberPlate( )      const       {
        return eNumberPlate;
    }
    ...
    inline Int_t        GetProposedMiddlePlate( )      const       {
        return eProposedMiddlePlate;
    }
    inline Int_t        GetProposedNumberPlate( )      const       {
        return eProposedNumberPlate;
    }

    inline TString      GetShowName( )      const       {
        return eName_Out_shower;
    }
