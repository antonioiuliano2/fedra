...
void EdbShowerRec::Energy_ExtractShowerParametrisationProfile()
{
 ...
 //ouput file
  ...
  if (!eShowerTreeIsDone) { 
    ...
    //treesaveb->SetBranchAddress("energy_shot_particle", &energy_shot_particle);
...
*/
  ...
  //ShowerParametrisationTree->Branch("energy_shot_particle",&energy_shot_particle,"energy_shot_particle/F");
  ShowerParametrisationTree->Branch("energy_shot_particle",&E_MC,"E_MC/F");
	...
	// ShowerParametrisationTree->Branch("EnergyMC",&energy_shot_particle,"EnergyMC/F");
 ...
 ShowerParametrisationTree->Branch("Energy",&EnergyCorrectedb,"EnergyCorrectedb/F");
  ...
  //=C= Loop over reconstructed Showers (Entries):
    ...
    // EnergyMC=energy_shot_particle;
    EnergyMC=E_MC;
   
    //------------------------------------------
    
    if (gEDBDEBUGLEVEL>3) cout << "void EdbShowerRec::Energy_ExtractShowerParametrisationProfile() === " << mlp->GetStructure()<<endl; ///DEBUG OPTION
    if (gEDBDEBUGLEVEL>2) cout << "void EdbShowerRec::Energy_ExtractShowerParametrisationProfile() ===  EnergyUnCorrectedb, EnergyUnCorrectedb,EnergyMC:    " <<  EnergyUnCorrectedb << "    ==  " << EnergyCorrectedb << "      " <<  energy_shot_particle << endl; ///DEBUG OPTION
  ...
  /* 
  FileShowerParametrisationTree = new TFile("FileShowerParametrisationTree.root","RECREATE");
  ShowerParametrisationTree->Write();
  FileShowerParametrisationTree->Close();
  delete FileShowerParametrisationTree;
  */
  fileout3->cd();
  treesaveb3->Write();
  fileout3->Close();         
