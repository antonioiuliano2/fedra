...
//----------------------------------------------------------------------------------------
int EdbPlateTracking::FindCandidateMTDS( EdbPattern &fnds1, EdbPattern &fnds2, EdbSegP &fnd,EdbSegP &spred, float maxdmin = 1.)
{
  EdbSegP s1,s2;
...
//----------------------------------------------------------------------------------------
int EdbPlateTracking::FindBestCandidateDS(EdbPattern &cand, EdbSegP &fnd, EdbPattern &passed, float wmin, float wmindegrad, float chi2max,EdbSegP &spred, float maxdmin = 1.)
{
  int n=0;
...
//----------------------------------------------------------------------------------------
int EdbPlateTracking::FindPredictionDS( EdbSegP &spred, EdbSegP &fndbt, EdbSegP &fnds1, EdbSegP &fnds2, EdbSegP &snewpred, float maxdmin = 1.)
{
  // Select the best (micro or base) track matching with the prediction
  // and prepare for a new search.
  //
