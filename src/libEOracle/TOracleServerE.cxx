...
//------------------------------------------------------------------------------------
Int_t  TOracleServerE::ReadVolume_NI(ULong64_t id_volume, EdbPatternsVolume &vol)
{
        char id[24];
        sprintf(id,"%lld",id_volume);
...
//------------------------------------------------------------------------------------
Int_t  TOracleServerE::ReadVolume_NI(ULong64_t id_volume, EdbPatternsVolume &vol, Int_t min_pl, Int_t max_pl)
{
        char id[24];
        Int_t min= min_pl;
        Int_t max= max_pl;
...
//------------------------------------------------------------------------------------
Int_t  TOracleServerE::ReadVolume_NI(char *id_volume, EdbPatternsVolume &vol)
{
  int  nsegtot=0;
  char query[2048];
  TObjArray patterns(100);
...
//------------------------------------------------------------------------------------
Int_t  TOracleServerE::ReadVolume_NI(char *id_volume, EdbPatternsVolume &vol, Int_t min, Int_t max)
{
  int  nsegtot=0;
  char query[2048];
  TObjArray patterns(100);
...
//------------------------------------------------------------------------------------
bool  TOracleServerE::ReadZplate_NI(int id_eventbrick, int id_plate, EdbPattern &pat)
{
