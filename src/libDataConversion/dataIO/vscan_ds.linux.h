...
const int VS_DATA_BYTES=0x30;
const int VS_HEADER_BYTES=0x60;

const int VS_OLD_HEADER_TYPE =	0x701;
const int VS_HEADER_TYPE	=	0x702;

#define VS_COMPRESSION_NULL				0
const int VS_COMPRESSION_METHOD = 0x100;
//#define VS_COMPRESSION_METHOD			0x100

//#define VS_COMPRESSION_GRAIN_SUPPRESSION	(VS_COMPRESSION_METHOD + 2)
const int VS_COMPRESSION_GRAIN_SUPPRESSION = VS_COMPRESSION_METHOD + 2;
